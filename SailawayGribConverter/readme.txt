...
Usage
-----
- Download wgrib2 from https://ftp.cpc.ncep.noaa.gov/wd51we/wgrib2/Windows_64/ (download all files and copy them to a new directory of your choice).
- Create a Desktop shortcut (or Autostart shortcut) to `SailawayGribConverter.exe`.
- Append "<Path to qtVLM grib directory>" "<Full path to wgrib2.exe>" to the Target field in the shortcut´s properties.
...
- Exit the program by right-clicking on its tray icon.
